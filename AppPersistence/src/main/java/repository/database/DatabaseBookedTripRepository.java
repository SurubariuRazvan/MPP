...
import repository.BookedTripRepository;
...
public class DatabaseBookedTripRepository extends AbstractDatabaseRepository<BookedTripID, BookedTrip> implements BookedTripRepository {
    public DatabaseBookedTripRepository(CRUDValidator<BookedTrip> validator, Properties props) {
