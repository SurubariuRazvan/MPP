...
public class DatabaseTripRepository extends AbstractDatabaseRepository<Integer, Trip> implements TripRepository {
    public DatabaseTripRepository(CRUDValidator<Trip> validator, Properties props) {
